...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="min-h-screen flex flex-col items-center justify-center py-20 px-4 w-full relative bg-slate-50 dark:bg-surface transition-colors duration-300">
      <div className="w-full max-w-6xl text-center">
        <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-5 flex items-center justify-center gap-3">
          <Layers className="text-primary dark:text-primary" /> Proyectos Destacados
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div key={index} className="group bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:border-primary/50 transition-all hover:shadow-2xl hover:shadow-primary/10 flex flex-col">
              ...
              <div className="h-48 w-full overflow-hidden relative border-b border-slate-200 dark:border-slate-800 cursor-pointer" onClick={() => setSelectedProject(project)}>
                ...
                <div className="absolute top-4 right-4 bg-primary-dark text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider shadow-lg">
                  {project.category}
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-8 -mt-6 relative">
              ...
              <span className="text-primary-dark dark:text-primary text-sm font-semibold tracking-wider uppercase mb-6 block">
              ...
              <div className="mb-8">
                <h4 className="text-slate-900 dark:text-white font-semibold mb-3 flex items-center gap-2">
                  <CheckCircle2 size={18} className="text-primary" /> Funcionalidades clave:
                </h4>
              ...
              <div className="flex gap-4 border-t border-slate-200 dark:border-slate-800 pt-6">
                 <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-primary-dark hover:bg-primary text-white py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors"
                 >
